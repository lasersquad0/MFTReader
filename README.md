...
There are however some article in Internet describing NTFS filesystem structure with different levels of details.
MFTReader application is based on this information found in Internet.
